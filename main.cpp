...
// Copyright (c) 2013 The Ucoin developers
...
uint256 hashGenesisBlock("0x00000b08558d0b9953c9a002c22fd2fdb8573c2a74e197ae45af09b8c12e4ec4");
static const unsigned int timeGenesisBlock = 1487582150;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "2017. The Ucoin release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x9a9545d17e08fce93eb6ddb7905fcc4ebb47c98da2b9aa81ad7b362f79f60943"));
...
unsigned char pchMessageStart[4] = { 0x63, 0x32, 0x97, 0x33 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UcoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running UcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
