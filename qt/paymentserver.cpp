...
const QString BITCOIN_IPC_PREFIX("Ucoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Ucoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Ucoin: click-to-pay handler");
    else
...
{
    // clicking on Ucoin: URLs creates FileOpen events on the Mac:
